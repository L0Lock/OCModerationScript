...
Pour ajouter un message, il faut simplement ajouter un élément de ce format dans le fichier JSON. Attention à bien préciser un id inexistant dans la liste ...
